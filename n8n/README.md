...
| `email-offer-ingestion/extract-body-blocks.js` | `8oPUD8d9NPVBEime` | Extract Body Blocks | full source + fix, **not published** |
| `email-offer-ingestion/flatten-block.js` | `8oPUD8d9NPVBEime` | Flatten Block | full source + fix, **not published** |
