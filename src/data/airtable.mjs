...
//
// {Public Listing}='Yes' is the single source of truth for what is publishable.
// It is maintained in Airtable and already guarantees the row is live: no
// supplier detail, nothing expired or stale. Do not add a second gate here —
// duplicating that logic in code just creates two definitions to keep in step.
//
